    ...
    _createClass(VolumeSlider, [{
        ...
        value: function clearIcons() {
            ...
            [0, 1, 2, 3].forEach(function (i) {
                _this2.classListRemove(_this2.volumeButton, 'icon_icVol' + i);
            });
        }
    }, {
        key: 'updateIcon',
...
var CastButton = function (_BaseElement) {
    ...
    function CastButton(meister, config) {
        ...
        _this.isChromecastAvailible(function (available) {
            ...
            _this.classListAdd(_this.element, 'pf-icon_icCast');
...
var _meister = __webpack_require__(38);
...
var update = __webpack_require__(37)(content, {"sourceMap":true});
